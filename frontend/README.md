...
| **REST API** | [tarimtoptan-api.onrender.com](https://tarimtoptan-api.onrender.com) |
| **API Base URL** | `https://tarimtoptan-api.onrender.com/v1` |
...
5. Environment Variables:
   ```
   VITE_API_URL=https://tarimtoptan-api.onrender.com/v1
   ```
6. Deploy et
