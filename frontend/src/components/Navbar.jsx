...
import { FiShoppingCart, FiUser, FiLogOut, FiMenu, FiX, FiPackage, FiUsers, FiPlusSquare } from 'react-icons/fi'
                ...
                <div className={`navbar-links ${menuOpen ? 'open' : ''}`}>
                    ...
                    {isAuthenticated ? (
                        <>
                            ...
                            <Link to="/products/manage" className={isActive('/products/manage')} onClick={() => setMenuOpen(false)}>
                                <FiPlusSquare /> Ürün Ekle
                            </Link>
